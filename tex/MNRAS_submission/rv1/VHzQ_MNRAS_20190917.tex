...
$Y$-band of MMT J0215-0529. Only one quasar, SDSS J0349+0034, 
shows significant differences between WFCAM and VISTA magnitudes in one band
With supermassive black hole accretion
...
observe in the $Z$-band.
  ...
  the positions of our 488 VH$z$Qs. This database is
  world-readable and we give the full recipe and relevant SQL queries
  for accessing both databases in Appendices~\ref{sec:SQL_WSA}
  and~\ref{sec:SQL_VSA} as well as online.
...
above the background noise.
  ...
  selects one quasar, SDSS J0349+0034, 
  with large, $\delta$mag $>0.2$mag differences between the WSA and VSA.
  SDSS J0349+0034, has a WSA $K$-band magnitude of 21.03$\pm$0.24
  mag AB, while for the VSA $K_s$-band this is 20.21$\pm$0.10 mag AB. 
...
{\bf Between the journal submitted version of this paper (which was
