...
differences between their WFCAM and VISTA magnitudes in one band. All
...
\begin{figure}
  ...
  \vspace{-14pt}
    \caption{The (W2-W3) vs. (W1-W2) colour – colour diagram showing the WISE colours 
      ...
      \citep{Paris2019} are also shown
      (grey colour-scale). }
    \label{fig:W1W2W3}
\end{figure}
...
\citep[e.g][]{Stern2012, Assef2012, Secrest2015, LaMassa2017, Assef2018, Glikman2018, LaMassa2019} 

The VH$z$Q with the bluest colour in (W1 - W2) is 
DELS J1048-0109 with (W1-W2) = 0.154. 
%(see Figure~\ref{fig:DELS_J1048}).

Figure~\ref{fig:W1W2W3} shows the (W1-W2) vs. (W2-W3) colour-colour diagram for the 283 VH$z$Qs that have reported {\tt w3mpro} values (blue to red coloured points), though we note that only 51 (18\%) of these objects have {\tt w3snr} $>$3.0. Approximately 400,000 quasars at redshift $z\lesssim3.0$ from the SDSS Quasar Catalog using the Fourteenth data release 
\citep[DR14Q; ][]{Paris2018} are also shown (grey colour-scale). 
