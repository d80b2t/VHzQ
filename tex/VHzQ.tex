...
\begin{itemize}
	\item 1) Coordinate update in original reference, from submitted to accepted; 
	\item 2) Coordinate different in RC submitted
	\item 3) Redshift different in RC submitted, typically very small changes. 
	\item 4) Our coords incorrect, but KP had 2 entries, one also incorrect
	\item 5) Coordinates incorrect in KP.
	\item 6) Two objects with similar looking coordinates and identical redshifts.
	These appear to be incorrect entries further back in the literature. 
\end{itemize}  
}}
