...
where flux is recovered at the spectroscopic position of the quasar,
...
the positions of our 424 VH$z$Qs. We return a database with $xxxx$
entries. This database is world-readable and we give the full receipe
and relevant SQL queries in Appendix~\ref{sec:SQL}.
    ...
    averaging process starts at the first epoch and works on.
    %%
    We give examples of the SQL queries syntax in Appendix~\ref{sec:SQL}.
           
    114 quasars have both WFCAM and VISTA data. 
...
\end{itemize}
Then going to the \href{http://wsa.roe.ac.uk:8080/wsa/SQL_form.jsp}{[\tt Free Form SQL 
Query} page the Database release {\tt WSERV1000v20180716} can be accessed which 
contains all the data we use here. 
