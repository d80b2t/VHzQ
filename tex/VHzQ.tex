...
Quasars are known to have dramatically changing Balmer lines, especially H$\beta$ \citep[e.g.,][]{LaMassa2015, Ruan2016, Runnoe2016, Macleod2016, Gezari2017, Runco2016, Yang2017, Assef2018, Stern2018, Wang2018, Ross2018, MacLeod2019, Graham2019}. As a guide, we note that H$\alpha$ is redshifted to 3.94$\mu$ (i.e. W1) at $z=5.00$ and 5.57$\mu$m, which is between the W2 and W3-bands at $z=7.50$. 
H$\beta$ is redshifted to 2.92$\mu$m, which is the blue edge of W1, at $z=5.00$ and 
4.13$\mu$m at $z=7.50$. 
%%
Less well understood is the temporal behvaiour of the metal lines, in particular \civ and \mgii. 
\civ enters the
...
Using the extended datasets described in Section~\ref{sec:NIR_data}, we find there are 27 WFCAM and 16 VISTA objects with at least 8 measurements observed with durations over 30 days, in at least one filter. 4 objects are in common to both, so this sample of 39 is our starting point for variability investigations. The four objects in common are: CFHQS J0216-4555; SDSS J0959+0227; SDSS J1000+0234; VIK J1148+0056. 
%% is SDSSJ0958+3524 special at all??
