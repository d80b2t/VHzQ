...
band. In the two shorter bands W1/2 we see the clear and expected
...
not the R90 catalogue matches to ULAS J1120+0641
\citep{Mortlock2011}. Neither catalogue matches to J1342+0928
\citep{Banados2018}.
...
The are a set of VH$z$Q detected in WISE W3 and W4. 51 objects are detected in the broad W3 filter and 10 objects are formally 
detected in W4 ({\tt w4snr}$\geq$3.0). Four of the brightest W4 objects are presented in  \label{fig:VHzQ_W4s}.
UHS J0439+1634 (Fig.~\ref{fig:VHzQ_W4s} (a)) with W4=7.165$\pm$0.12 was discovered by \citet{Fan2019}
 and is a strongly lensed quasar at $z=$6.51. This high luminosity is most not intrinsic, but is 
boosted by an intervening redshift $z\sim$0.7 galaxy. 
SDSS J0100+2802 (redshift $z=6.33$) does not have a formal W4 detection (W4 $=8.98\pm0.45$ and {\tt w4snr}=2.4) but 
as reported by \citet{Wu2015}, has a bright detections in the 2MASS $J$, $H$ and $K_{\rm s}$ bands and we report it here.  
