...
system \cites{Oke_Gunn1983, Fukugita1996}.  This includes the
...
$\Lambda$CDM cosmology with $H_0 = 67.7$ km s$^{-1}$ Mpc$^{−1}$, $\Omega_{\rm
...
Here we are not just querying the WSA or VSA data tables. We are taking
a list of objects (positions) and are performing matched aperture
...
Explorer (WISE) mission, and we utilize data from the WISE cryogenic
