...
% and give our caculcated $M_{1450}$. 
...
\hline  
  ...
  DELS               &   16       &  \citet{Dey2018} \\
  ELAIS              &     1       &  \citet{Vaisanen2000} \\
  FIRST              &     1       &  \citet{Becker1995} \\
  HSC                 &    8        & \citet{Miyazaki2018} \\
  IMS                 &     5        &  \citet{Kim2015} \\
  MMT               &   12        &  \citet{McGreer2013} \\
  NDWFS           &     1         &  \citet{JD1999} \\
  PSO                 &   83         &   \citet{Kaiser2002, Kaiser2010} \\
  RD                   &     1         &  \citet{Mahabal2005} \\
  SDSS                &  170         & \citet{EDR} \\
  SDUV$^{a}$       &   20         & \citet{YangJ2017} \\
 SDWISE$^{b}$    &   27         &   \citet{WangF2016} \\
%  SHELLQs         &  $^{c}$63   &  \citet{Matsuoka2016} \\  %% if you include 8 objects from the first HSC paper...
  SHELLQs         &    55         &  \citet{Matsuoka2016}     \\  
  UHS               &    1            &  \citet{Fan2018} \\
  ULAS               &   10          & \citet{Lawrence2007} \\
  VDES$^{c}$              &   17          &  \citet{Reed2017} \\
