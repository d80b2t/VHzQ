...
we select objects with at least 8 measurements observed with intervals of 
at least 30 days, in at least one filter. 
The the average calibrated flux over all epochs must be $>0$ 
(i.e. {\tt aperJky3}$>0$) 
with the signal-to-noise is required to be $\geq8$. 
(i.e. {\tt aperJky3/aperJky3Err}$>=$8).
The clipped median and standard deviation is then calculated 
\begin{equation}
...
These are: 
MMTJ0215-0529 (Figure~\ref{fig:MMTJ0215-0529}), 
CFHQSJ0216-0455 (Figure~\ref{fig:CFHQSJ0216-0455}), 
SHELLQsJ0220-0432 (Figure~\ref{fig:SHELLQsJ0220-0432}) and 
SDSS J0959+0227 (Figure~\ref{fig:SDSSJ0959+0227}). 
...
\begin{figure}
  \begin{subfigure}{}\quad
    ...
    \caption{SHELLQs J0220-0432}
    \label{fig:SHELLQsJ0220-0432}
  \end{subfigure}
  \begin{subfigure}{}\quad
    \centering
    \includegraphics[width=8.5cm]{../light_curves/SDSSJ0959+0227LC_20190612.png}
    \caption{SDSS J0959+0227}
    \label{fig:SDSSJ0959+0227}
  \end{subfigure}
  \medskip
\end{figure}

Even with well sampled data across the 3000-4000 day observed time-scales that the WFCAM and VISTA surveys span, the $(1+z)$ time-dilation dramatically affects the sampled rest-frame timescales sampled. 


SDSS J0959+0227 is in the VH$z$Q sample from \citet{Wang2016} 
%% Wang et al. 2016, ApJ, 819, 24, and their Table1. 
but is first reported in \citet{Civano2011} as CID-2220 (CXOCJ095908.1+022707), 
%2011, ApJ, 741, 91 
a high-redshift, $z>3$ AGN in the Chandra-COSMOS field. 
%%
The spectrum from this object is presented in \citet{Ikeda2012} 
% et al., 2012, ApJ, 756, 160, 
and is called object ``No. 11'' in that papers' Table 1. 
and it is a beauty!! Figure 2 with the spectrum is attached. 
\citet{Ikeda2012} show SDSS J0959+0227 having a narrow Ly$\alpha$ line, 
and would likely be a Lyman-$\alpha$ emitting galaxy had it not been an X-ray source, 
The X-ray luminosity is $\approx3x10^44$ erg s$-1$ in the 2–10 keV rest-frame, 
so it is an AGN. This object is clearly not a regular broadline ``Type 1'' AGN, but  
if there is even the slightest of variability, this could potentially be a high-$z$ 
AGN transitioning from a narrow-line ``Type 2'' object to a broadline Type 1 quasar. 
