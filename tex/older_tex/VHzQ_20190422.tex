...
sample has 170 objects with redshift $z \geq 6.00$ (with $x$ detected
in WISE {\bf NPR to double check!!}). \citet{Banados2016} reports WISE
W1, W2, W3 and W4 magnitudes for the Panoramic Survey Telescope and
Rapid Response System 1 \citep[Pan-STARRS1, PS1;][]{Kaiser2002,
Kaiser2010}, but with no further investigation into the reddest WISE
waveband for the VH$z$Qs.
...
luminosity-redshift $Lz$-plane.
    ...
    \end{table}
     ...
     There are 17 objects that have no NIR detections. 
     2 of these (PSOJ053.9605-15.7956 and PSO J056.7168-16.4769) 
     have been observed, but are out of our queried time range. 
     10 objects have not been observed (or at least the data is not in the WSA/VSA 
