...
There were two QSOs in the Perger catalogue which could not be immediately fixed
by looking up the original coordinates in the literature: SDSSJ0835+3227 and VA-13492.
In both cases the coordinates looked similar to SDSSJ0835+3217 and
SDSSJ1040-1155, respectively, and the stated redshifts were identical to these
quasars. In the case of SDSSJ0835+3227, we checked the SDSS $z$-band
...
been transcribed incorrectly sometime in the past. The SDSSJ1040-1155 
transcription error seems to have occurred after \cite{Douglas2007} and is in
\cite{Flesch2015}, so it probably occurred in the \cite{Flesch2015}.
