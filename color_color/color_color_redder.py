...
ax1.scatter((z_PS1 - y_PS1), (Jmag - Kmag), c=redshift, cmap=cmap, s=ms, alpha=1.0)
## Spectral Type
cmap = plt.cm.rainbow
ax1.scatter((zmag - ymag), (J_tm - Ks_tm), c=(SpT_optn**5.), cmap=cmap, alpha=0.60, s=ms_small)
...
ax1.set_xlabel(r" z - y ", fontsize=labelsize)
ax1.set_ylabel(r" J - K ", fontsize=labelsize)
...
## Quasars
cmap = plt.cm.autumn_r
ax2.scatter((z_PS1 - y_PS1), (y_PS1 - W1mag), c=redshift, cmap=cmap, s=ms, alpha=1.0)
## Spectral Type
cmap = plt.cm.rainbow
ax2.scatter((zmag - ymag), (ymag - W1_star), c=(SpT_optn**5.), cmap=cmap, alpha=0.60, s=ms_small)
...
ax2.set_xlabel(r" z - y ", fontsize=labelsize)
ax2.set_ylabel(r" y - W1", fontsize=labelsize)
...
## Quasars
cmap = plt.cm.autumn_r
ax3.scatter((z_PS1 - y_PS1), (W1mag - W2mag), c=redshift, cmap=cmap, s=ms, alpha=1.0)
## Spectral Type
cmap = plt.cm.rainbow
ax3.scatter((zmag - ymag), (W1_star - W2_star), c=(SpT_optn**5.), cmap=cmap, alpha=0.60, s=ms_small)
...
ax3.set_xlabel(r" z - y ", fontsize=labelsize)
...
## Quasars
cmap = plt.cm.autumn_r
ax4.scatter((y_PS1 - Jmag), (Jmag - Kmag), c=redshift, cmap=cmap, s=ms, alpha=1.0)
## Spectral Type
cmap = plt.cm.rainbow
ax4.scatter((ymag - J_tm), (J_tm - Ks_tm), c=(SpT_optn**5.), cmap=cmap, alpha=0.60, s=ms_small)
...
ax4.set_xlabel(r" y - J ", fontsize=labelsize)
ax4.set_ylabel(r" J - K ", fontsize=labelsize)
...
## Quasars
cmap = plt.cm.autumn_r
ax5.scatter((y_PS1 - Jmag), (Jmag - W1mag), c=redshift, cmap=cmap, s=ms, alpha=1.0)
## Spectral Type
cmap = plt.cm.rainbow
ax5.scatter((ymag - J_tm), (J_tm - W1_star), c=(SpT_optn**5.), cmap=cmap, alpha=0.60, s=ms_small)
...
ax5.set_xlabel(r" y - J ", fontsize=labelsize)
ax5.set_ylabel(r" J - W1 ", fontsize=labelsize)
...
## Quasars
cmap = plt.cm.autumn_r
ax6.scatter((y_PS1 - Jmag), (W1mag-W2mag), c=redshift, cmap=cmap, s=ms, alpha=1.0)
## Spectral Type
cmap = plt.cm.rainbow
ax6.scatter((ymag - J_tm), (W1_star-W2_star), c=(SpT_optn**5.), cmap=cmap, alpha=0.60, s=ms_small)
...
ax6.set_xlabel(r" y - J ", fontsize=labelsize)
ax6.set_ylabel(r" W1 - W2 ", fontsize=labelsize)



plt.savefig('color_color_redder_temp.png', format='png')
plt.savefig('color_color_redder_temp.pdf', format='pdf')
plt.close(fig)
