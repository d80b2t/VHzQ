...
above the background noise.
  ...
  negative and all of the WFCAM ones are positive except in the J-band where
  VISTA is marginally positive and WFCAM marginally negative.
  The $Ks$ versus $K$ band comparison may be affected the different shapes of the filters,
  ...
  selects one quasar\footnote{In the submitted version arXiv:1906.06974v1, we
  claimed a second QSO, SDSSJ2220-0101, but while updating the catalogue, see
  App~\ref{app:qso_sample}, we found a small number of WSA matched aperture
  photometry had been assigned to incorrect apertures, mainly for this source.} 
  with large, $\delta$mag $>0.2$mag differences between the WSA and VSA.
  This is SDSSJ0349+0034, which has a WSA $K$-band magnitude of 21.03$\pm$0.24
  mag AB, while for the VSA $K_s$-band this is 20.21$\pm$0.10 mag AB\footnote{In
  the submitted version, arXiv:1906.06974v1, these the Vega magnitudes were
  published instead of the AB for this QSO.}.
...
catalogue\footnote{http://astro.elte.hu/$\sim$perger/catalog.html} again
matching on a $2\arcsec$ radius. We found several objects that were in both
catalogues but had disagreement on the coordinates. Most of these were
fixed by checking the literature for the original catalogue.

There was one QSO in the Perger catalogue which could not be immediately fixed
by looking up the original coordinates in the literature: VA-13492.
In this case the coordinates looked similar to SDSSJ1040-1155, and
the stated redshift was identical, $z=5.44$. Additionally, in this case,
the $i$-band magnitude was equivalent to SDSS J1040-1155
($i=25.9$ mag), so we have decided that both of these objects are the same and 
have been transcribed incorrectly sometime in the past. The SDSSJ1040-1155 
transcription error seems to have occurred after \cite{Douglas2007} and is in
\cite{Flesch2015}, so it probably occurred in \cite{Flesch2015}.
 

The five objects from the submitted version of Ross \& Cross that have
changed position are in Table~\ref{tab:disagree_objs}. The
...
\begin{tabular}{l r r r r r}
\hline  \hline
QSO & ra & dec & redshift & difference \\
 & deg & deg & & arcsec  \\
\hline
%% QSOs where pos changed (same name)
DELSJ1048-0109 & +162.0795417 & -1.1611694 & 6.678 & 12.1 \\
SHELLQsJ1429-0002 & +217.3342500 & -0.0353889 & 6.04 & 150.0 \\
DELSJ1559+2212 & +239.7878750 & +22.2040083	& 6.07 & 3.0 \\
ATLASJ332.8017-32.1036 & +332.8017500 & -32.1035556	& 6.3394 &	3.2 \\
VIKJ2318-3113 & +349.5764625 & -31.2295417 & 6.4435 & 239.9 \\
\hline  \hline
\end{tabular}
\caption{{\bf QSOs where the coordinates are in  disagreement between
the submitted (arXiv v1) and accepted version of the paper.}}
